...
const About = () => {
  return (
    <div className="about-container">
      <div className="flex flex-col gap-10 md:gap-[50px] items-center bg-[#F2F2F2] dark:bg-primary/[7%] about-me-padding">
        <div className="">
        ...
        <div className="flex items-center flex-col-reverse gap-[30px] md:gap-[79px] md:flex-row">
          <div className=" lg:w-[551px] lg:h-[351px]">
            <p className="text-sm font-normal leading-6 text-left md:leading-8 md:text-base ">
              ...
              in React.js, Tailwind CSS, and Next.js. I bring a blend of
              technical expertise and creative flair to the table, constantly
              seeking to craft user-centric and visually appealing web
              experiences.
              <br />
              <br />
